...
typedef struct {
  ...
  uint16_t TotalMemory; /* Number of 64kb memory block */

  /* For VBE 2.0 standard */
...
/**
 * @brief Gets controller info in specified format
